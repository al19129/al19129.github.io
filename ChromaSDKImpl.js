...
// chromaSDKオブジェクトを作るインスタンス関数的なもの？
function ChromaSDK() {
    // 初期化時のプロパティはこの2つ．下のほうでプロパティが追加されているっぽい
    var uri;
    var timerId;
}
...
// HTMLのscripタグ内でインスタンス化されたインスタンスであるChromaSDKに対する処理かも
// ChromaSDKオブジェクトにprototypeオブジェクトをプロパティとして追加している？
ChromaSDK.prototype = {
    init: function () {
        var request = new XMLHttpRequest();
